...
prompt Created by GKRD_IT_03_NEW on 2020年12月17日
set define off
...
comment on column CONTRACTMS.IT_CONTRACT_HDR.prjflag
  is '项目类型，参见parameter type=PARA002，默认16无项目';
...
and (l.listtype = '00' or nvl(l.listtype,'00') = '00')  --本条件用于过滤未付款项目
